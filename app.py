...
st.title('Network Security With Machine Learning - EPICS')
...
if st.button('Predict'):
    ...
    if prediction == 0:
        st.success('Prediction: Normal traffic (class 0) predicted')
    else:
        st.error('Prediction: Anomaly traffic (class 1) predicted')